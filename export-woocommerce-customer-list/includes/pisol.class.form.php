...
class pisol_class_form_ewcl{
    ...
    function bootstrap_switch_category($label, $field, $desc = "", $links = ""){
        ?>
        <div id="row_<?php echo esc_attr($this->setting['field']); ?>" class="row py-4 border-bottom align-items-center <?php echo esc_attr( isset($this->setting['class']) ? $this->setting['class'] : "" ); ?>">
            <div class="col-9">
            <?php echo wp_kses($label, $this->allowed_tags) ; ?>
            <?php echo wp_kses($desc != "" ? $desc.'<br>': "", $this->allowed_tags); ?>
            <?php echo wp_kses($links != "" ? $links: "", $this->allowed_tags); ?>
    ...
    */
    ...
    function setting_category(){
        ...
        <div id="row_<?php echo esc_attr($this->setting['field']); ?>" class="row py-4 border-bottom align-items-center <?php echo esc_attr( isset($this->setting['class']) ? ($this->setting['class']) : "" ); ?>">
            <div class="col-12">
            <h2 class="mt-0 mb-0 <?php echo esc_attr( isset($this->setting['class_title']) ? ($this->setting['class_title']) : "" ); ?>"><?php echo esc_html($this->setting['label']); ?></h2>
            </div>
        </div>
        <?php
        endif;
