...
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-pisol-guest-data-extractor.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-notification.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-pisol-ewcl-ajax-guest-data-extractor.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-pisol-ewcl-ajax-registered-data-extractor.php';


require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-pisol-ewcl-menu.php';
